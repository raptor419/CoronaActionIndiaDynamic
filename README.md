...
**Open-Source Coronavirus Dashboard** coded in **[Django Framework](https://www.djangoproject.com/)** on top of **Admin Dashboard** design.
...
```bash
$ # Get the code
$ git clone https://github.com/raptor419/CoronaActionIndiaDynamic
$ cd CoronaActionIndiaDynamic
$
$ 
$ # Install modules
$ # SQLIte version
